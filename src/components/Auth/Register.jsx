        ...
        <>
            ...
            <form className="register" onSubmit={formik.handleSubmit} noValidate>
                ...
                <div className="register__box">
                    ...
                    />
                    {formik.errors.email ? <div className="register__error">{formik.errors.email}</div> : null}
                </div>
                ...
                <div className="register__box">
                    ...
                    />
                    {formik.errors.password ? <div className="register__error">{formik.errors.password}</div> : null}
                </div>
                ...
                <div className="register__box">
                    ...
                    {formik.errors.repeatPassword ? (
                        <div data-cy="validationRepeatPassword" className="register__error">
                            {formik.errors.repeatPassword}
                        </div>
                    ) : null}
                </div>
